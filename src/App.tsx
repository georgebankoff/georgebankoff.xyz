  ...
  return (
    <div className="App">
      ...
      <div className="spaced">
        ...
        <div>
          <img src="/moon-trail.webp" className="image"></img>
          <p className="description">
            This is a composite star trail photo of the same frame of the previous photo over a couple hours. You can see the Moon rising. I had gone to bed as the Moon had started to rise and set my camera to capture 30-second exposures on repeat for 2 hours. Since the 5D Mark III has a full sensor, it distorts the real image when used with the fisheye lens, so you can see the ellipse around Polaris is not perfectly circular, which looks really cool. Since I wasn't able to adjust the exposure to make the Moon clearer while I was gone, it produced this cool effect, making the moon seem like it is a flame in the sky.
          </p>
        </div>
        <div>
          <img src="/long.webp" className="image"></img>
          <p className="description">
        ...
        <div>
          <img src="/eddie-exposed.webp" className="image"></img>
          <p className="description">
            This is a light painting of me with an artistic representation of my dog, Eddie, in front of the Milky Way. It is a 30-second exposure. This one took me a few tries. It's like a very advanced selfie where I had to use a flashlight in the dark to draw a picture of my dog while my shutter was open. The first couple of tries were ok, but his legs were too long. This one came out well.
          </p>
        </div>
      </div>
      <div className="black">
      <div className="about">
        <div>
          ...
          <p className="about-text">
            I am a high school student at Sidwell Friends school. I have lived in DC my whole life. I am driven by trying to understand things.
          </p>
        </div>
